...
function main() {
    ...
    for (var i = 0; i < 46; i++) { //black rectangles
        for (var j = 0; j < 28; j++) {
    ...
    var myFilter = new PIXI.filters.BlurFilter();
    myFilter.blur = 4;
    myFilter.quality = 6;
    background.filters = [myFilter];
    var allFilter = new PIXI.filters.ColorMatrixFilter();
