...
function initScene() {
   ...
   //https://github.com/mrdoob/three.js/pull/14087#issuecomment-431003830
    ...
    new THREE.TextureLoader().load('/resources/textures/uv_grid_opengl.jpg', function (texture) {
        ...
        texture.wrapS = texture.wrapT = THREE.RepeatWrapping; //anisotropy is the sampling rate basically
        texture.anisotropy = renderer.capabilities.getMaxAnisotropy(); //can make the anisotropy smaller
